    ...
    return Container(
      ...
      child: Column(
        ...
        children: List.generate(widget.destinations.length, (index) {
          final destination = widget.destinations[index];
          final selected = index == _toSelectedIndexFromTabRouter(widget.selectedIndex)[0];
                  ...
                  if (destination.hasDropdown &&
                    ...
                    DestinationDropdown(
                      ...
                      onSelectItem: (int ind) {
                        widget.onDestinationSelected(_toSelectedIndexFromDropdown(index, ind));
                        setState(() {
